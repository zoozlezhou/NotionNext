...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'd5bcfc87394f40fa95251d98f3f6a1cc',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '润物', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || ' 🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || ' ', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '润物', // 网站关键词 英文逗号隔开
